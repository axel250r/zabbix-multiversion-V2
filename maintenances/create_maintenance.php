...
<template id="template-period-4">
  ...
  <div class="form-group" style="margin-bottom:14px">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:4px 16px;margin-top:6px">
      <?php
      $months_list = [
        t('month_jan','January')=>1,  t('month_feb','February')=>2,
        t('month_mar','March')=>4,    t('month_apr','April')=>8,
        t('month_may','May')=>16,     t('month_jun','June')=>32,
        t('month_jul','July')=>64,    t('month_aug','August')=>128,
        t('month_sep','September')=>256, t('month_oct','October')=>512,
        t('month_nov','November')=>1024, t('month_dec','December')=>2048
      ];
